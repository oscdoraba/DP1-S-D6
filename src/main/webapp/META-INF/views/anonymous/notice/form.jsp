...
<acme:form>
	...
	<acme:form-textbox code="anonymous.notice.form.label.optional1" path="optional1"/>
	<acme:form-textbox code="anonymous.notice.form.label.optional2" path="optional2"/>
